...
DROP TABLE IF EXISTS `glpi_plugin_addressing_reservations`;
CREATE TABLE `glpi_plugin_addressing_reservations` (
   `id` int(11) NOT NULL auto_increment,
   `name` varchar(255) collate utf8_unicode_ci default NULL,
   `entities_id` int(11) NOT NULL default '0',    
   `networks_id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_networks (id)',    
...
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginAddressingReservation',1,3,0);
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginAddressingReservation',10,4,0);
INSERT INTO `glpi_displaypreferences` VALUES (NULL,'PluginAddressingReservation',20,5,0);
