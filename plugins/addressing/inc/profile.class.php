<?php
/*
 * @version $Id: profile.class.php 205 2016-03-08 16:55:49Z ludo $
 -------------------------------------------------------------------------
...
class PluginAddressingProfile extends Profile {
   ...
   static function getAllRights() {
      $rights = array(
          ...
          array('itemtype'  => 'PluginAddressingReservation', 
                'label'     => __('Manage reserved address', 'addressing'),
                'field'     => 'plugin_addressing_modify_reservation'));
      return $rights;
   }
