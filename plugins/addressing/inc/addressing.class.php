<?php
/*
 * @version $Id: addressing.class.php 205 2016-03-08 16:55:49Z ludo $
 -------------------------------------------------------------------------
...
class PluginAddressingAddressing extends CommonDBTM {
   ...
   static function displayTabContentForItem(CommonGLPI $item, $tabnum=1, $withtemplate=0) {
      if ($item->getType() == __CLASS__) {
         ...
         {             
            PluginAddressingReservation::showList($_GET);
         }
      }
      return true;
   }
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate=0) {
      return array(Report::getTypeName(1),PluginAddressingReservation::getTypeName(1));
   }
